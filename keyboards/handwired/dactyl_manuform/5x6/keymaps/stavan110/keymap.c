/* Qwerty with home row mods for the Dactyl Manuform 5x6 Keyboard */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6(
        ...
        SELWORD, KC_Q  , KC_W  , KC_E  , KC_R  , KC_T  ,    KC_Y   ,KC_U,     KC_I,   KC_O,   KC_P,   KC_BACKSLASH,
         KC_ESC, HOME_A, HOME_S, HOME_D, HOME_F, KC_G  ,    KC_H   ,HOME_J, HOME_K, HOME_L, HOME_SCLN,KC_QUOT,
           REPEAT,KC_Z, KC_X  , KC_C  , KC_V  , KC_B  ,     KC_N   ,KC_M  ,KC_COMM, TD_DOT,KC_SLSH,ARROW_R,
                         KC_LEFT,KC_RIGHT,                                    KC_UP, KC_DOWN,
                                        ...
                                        OS_LALT ,CAPS_WORD,   OS_LCTL, OS_LALT
  ),
 ...
 * |-------+-------|   W   |   E   |   R   |   T   | |   Y   |   U   |   I   |   O   |-------+------|
 * |SELWORD|   Q   |-------+-------+-------+-------| |-------+-------+-------+-------|   P   |BACKSL|
 * |-------+-------|HOME_S |HOME_D |HOME_F |   G   | |   H   |HOME_J |HOME_K |HOME_L |-------+------|
 * |  ESC  |HOME_A |-------+-------+-------+-------| |-------+-------+-------+-------|HOME_SC| QUOT |
 * |-------+-------|   X   |   C   |   V   |   B   | |   N   |   M   | COMM  |TD_DOT |-------+------|
 * |REPEAT |   Z   |-------+-------+---------------' `---------------+-------+-------| SLSH  |ARROW_|
 * `---------------| LEFT  | RIGHT |                                 |  UP   | DOWN  |--------------'
 *                 `---------------'                                 `---------------'
 *                                 ,---------------. ,---------------.
 *                                 | BSPC  |NAV_TAB| |SYM_ENT|  SPC  |
 *                                 |-------+-------| |-------+-------|
 *                                 |  IDE  |OS_LSFT| |OS_RSFT|  IDE  |
 *                                 |-------+-------| |-------+-------|
 *                                 |OS_LALT|CAPS_WO| |OS_LCTL|OS_LALT|
 ...
 * |-------+-------|   2   |   3   |   1   |   5   | |   6   |   0   |   8   |   9   |-------+------|
 * |   X   |   4   |-------+-------+-------+-------| |-------+-------+-------+-------|   7   | MINS |
 * |-------+-------| LBRC  | RBRC  |C_BRQOT|       | |O_BRACE| LCBR  | LPRN  | RPRN  |-------+------|
 * |       |O_BRQOT|-------+-------+-------+-------| |-------+-------+-------+-------| RCBR  |C_BRAC|
 * |-------+-------|  AT   | HASH  |  DLR  | PERC  | | CIRC  | AMPR  | ASTR  |  EQL  |-------+------|
 * | TILD  | EXLM  |-------+-------+---------------' `---------------+-------+-------| PLUS  | GRV  |
 * `---------------|       |       |                                 | COMM  |  DOT  |--------------'
 *                 `---------------'                                 `---------------'
 *                                 ,---------------. ,---------------.
 ...
 *                                 `---------------' `---------------'       generated by [keymapviz] */
  [_IDE] = LAYOUT_5x6(
        ...
        KC_TRNS, KC_TRNS  , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS ,    KC_TRNS  , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS ,KC_TRNS,
        KC_TRNS, KC_TRNS  ,KC_TRNS  ,KC_TRNS  ,KC_TRNS  , KC_TRNS ,    KC_TRNS  , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS ,KC_TRNS,
        KC_TRNS, KC_TRNS  ,KC_TRNS  ,KC_TRNS  ,KC_TRNS  , RFTR_RENAME ,    KC_TRNS  , KC_TRNS , KC_TRNS , KC_TRNS , COMMENT ,KC_TRNS,
                        _______,_______,                                    _______,_______,
                                            NAV,_______,    _______,_______,
                                        _______,_______,    _______,_______,
                                        _______,_______,    ADJUST, ADJUST
 ...
 * ,---------------|  F2   |  F3   |  F4   |  F5   | |  F6   |  F7   |  F8   |  F9   |--------------.
 * |  F12  |  F1   |-------+-------+-------+-------| |-------+-------+-------+-------|  F10  | F11  |
 * |-------+-------| NLCK  | SLCK  |  INS  |       | |       | PGUP  |  UP   | PGDN  |-------+------|
 * |       |       |-------+-------+-------+-------| |-------+-------+-------+-------|       | MUTE |
 * |-------+-------| LALT  | LSFT  | LCTL  | GNAV  | | HOME  | LEFT  | DOWN  | RGHT  |-------+------|
 * |MS_CAPS| LGUI  |-------+-------+-------+-------| |-------+-------+-------+-------|  END  | VOLU |
 * |-------+-------|C(KC_A)|C(KC_C)|C(KC_V)|       | |       | PSCR  | LCBR  | RCBR  |-------+------|
 * |       |YICODE |-------+-------+---------------' `---------------+-------+-------|  INS  | VOLD |
 * `---------------|       |       |                                 | BRID  | BRIU  |--------------'
 *                 `---------------'                                 `---------------'
 *                                 ,---------------. ,---------------.
